...
# Import RTL modules #
#####################
create_bd_cell -type module -reference Vortex_top Vortex_top
...
## DCR_VORTEX
create_bd_cell -type ip -vlnv user.org:user:DCR_Vortex:1.0 DCR_Vortex_0  

## MOD: VX CONSOLE
create_bd_cell -type ip -vlnv user.org:user:vx_console:1.0 vx_console_0
set_property CONFIG.CLK_FREQ_HZ {100000000} [get_bd_cells vx_console_0]

## AXI SMARTCONNECT 
# (As i can see Number of slave interfaces is automatically set) 
# MOD: Number of Master Interfaces is set to 4 (BRAM, DCR, GPIO, VX_CONSOLE) 
...
# ADD: UART INTERFACE
create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 uart_pl

### Interface Connections ### 

## BRAM Controller to BRAM 
...
## AXI SMARTCONTROLLER MASTER INTERFACE TO SLAVE

# M00 TO AXI BRAM CONTROLLER 
...
# ADD: M03 TO VX_CONSOLE
connect_bd_intf_net -intf_net smartconnect_0_M03_AXI [get_bd_intf_pins smartconnect_0/M03_AXI] [get_bd_intf_pins vx_console_0/s_axi]


## AXI SMARTCONTROLLER MASTER TO SLAVE INTERFACES 
...
## ADD: VX_CONSOLE TO UART_PL 
connect_bd_intf_net -intf_net vx_console_0_uart [get_bd_intf_ports uart_pl] [get_bd_intf_pins vx_console_0/uart]
...
# MOD: PROC SYS RESET ARESET (Active low) to AXI BRAM CTRL, AXI SMARTCONNECT, AXI GPIO, DCR VORTEX 
connect_bd_net -net Net [get_bd_pins proc_sys_reset_0/peripheral_aresetn] \
  ...
  [get_bd_pins vx_console_0/aresetn]

# MOD: ZYNQ ULTRASCALE PL CLOCK to VORTEX, BRAM CTRL, PROC SYS RESET, AXI SMARTCONNECT, AXI GPIO,
# ILA, DCR VORTEX, AXI HIGH PERFORMANCE MASTER PORT ZYNQ ULTRASCALE
...
assign_bd_address -offset 0xA0100000 -range 64K \
    -target_address_space [get_bd_addr_spaces Vortex_top/m_axi_mem] \
    [get_bd_addr_segs DCR_Vortex_0/S00_AXI/S00_AXI_reg] -force
...
assign_bd_address -offset 0xA0120000 -range 128 \
    -target_address_space [get_bd_addr_spaces Vortex_top/m_axi_mem] \
    [get_bd_addr_segs vx_console_0/s_axi/reg0] -force
...
puts "DEBUG: [get_bd_addr_segs -of_objects [get_bd_addr_spaces zynq_ultra_ps_e_0/Data]]"
...
# Set VHDL for project for HDL wrapper generation
...
add_files -norecurse $prj_dir/$project_name.gen/sources_1/bd/$bd_name/hdl/${bd_name}_wrapper.v 
